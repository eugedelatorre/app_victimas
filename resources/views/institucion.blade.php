         ...
         <form class="" action="/institucion.php" method="post">
            ...
            <div class="form-group ">
               ...
               <div id="cualA5" style="display: none;">
                  ...
                  <div class="">
                     <input class="form-control" name="Cuál" id="derivacion_otro_organismo_cual" type="text">
                  </div>
               </div>
            </div>
            <div class="form-group ">
            ...
            <div id="cualA12" style="display: none;">
               <br><label for="">Cuál?</label>
               <div class="">
                  <input class="form-control" name="motivo_pasivo" type="text" id="motivo_pase_pasivo_cual">
               </div>
            </div>
            <div class="form-group ">
