...
<html lang="en">
   ...
   <header>
     <ul class="nav nav-tabs">
       <li class="nav-item"><strong> <a class="nav-link "style="color:#3490dc;font-size:1.1em"  href="inicio">Inicio</a> </li></strong>
       <li class="nav-item"><strong> <a class="nav-link "style="color:#3490dc;font-size:1.1em"  href="paneldecontrol/{session("idCaso")}">Panel de Control</a> </li></strong>
     </ul>
   </header>
   <body>
...
@if($conviviente->idCaso==session("idCaso"))
            ...
            <a href="detalleconviviente/{{$conviviente->id}}">
              {{$conviviente->nombre_y_apellido}}</a>

              <strong>  <a style="color:red"href="detalleconviviente/deleteconviviente/{{$conviviente->id}}">
              ELIMINAR</a></strong>
            </li>
