...
<html lang="en">
  ...
  <div class="btn-4" style="width:11%;float:left;margin-left:40%"><input type ='button' style="width:100%" class="btn btn-danger col-xs" name="button" value = 'Eliminar' onclick="window.open('deleteimputado/{{$imputado->id}}', 'width=800,height=600');"/></button><br><br></div>
      </section>
