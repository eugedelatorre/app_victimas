...
<input type ='button' style="width:317px;background-color:grey;margin-left:39%" class="btn btn-danger col-xs" name="button" value = 'Agregar' onclick="window.open('detalleagregarProfesional')"/></button>
      <h5 class="text-center" style="padding: 15px;">
        ...
        @if($profesional->idCaso==session("idCaso"))
                ...
                <strong>{{$profesional->usuario->nombre_y_apellido}}</strong>

<div class="botones" style="overflow:hidden;margin-left:37%">
          <div class="btn1" style="float:left">  <input type ='button' style="width:150px;background-color:green" class="btn btn-danger col-xs" name="button" value = 'Editar' onclick="window.open('detalleProfesional/{{$profesional->id}}', 'width=800,height=600');"/></button></div>
<div class="btn2" style="float:left">   <input type ='button' style="width:150px; margin-left:13%" class="btn btn-danger col-xs" name="button" value = 'Eliminar' onclick="window.open('detalleProfesional/deleteprofesional/{{$profesional->id}}', 'width=800,height=600');"/></button></div>
</div>
              </li>
